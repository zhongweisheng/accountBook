 ...
 * 字符串处理工具类
 * 
 * @author fcpays 这里面的有些方法引用apache.commons.lang-2.3里的StringUtils类
 */
public class StringUtil {
    ...
    /**
     * null对象转换，参数对象为null时，返回null;否则返回对象的值。<br>
     * 
     * @param obj
     *            需要转换的对象
     * @return String 返回null、字符串或空字符串。
     */
    public static String nullVal( Object obj ) {
        if ( obj == null ) {
            return null;
        }
    ...
    /**
     * null对象转换，参数对象为null时，返回0字符串;否则返回对象的值(如果对象为null时进行trim()是可用这方法)。<br>
     * 
     * @param obj
     *            需要转换的对象
     * @return String 返回字符串或空字符串。
     */
    public static String dnvl( Object obj ) {
        if ( obj == null ) {
            return "0";
        }
        return obj.toString().trim();
    ...
    /**
     * null对象转换，参数对象为null时，返回0字符串;否则返回对象的整数值(如果对象为null时进行trim()是可用这方法)。<br>
     * 
     * @param obj
     *            需要转换的对象
     * @return String 返回字符串或空字符串。
     */
    public static String rnvl( Object obj ) {
        if ( obj == null ) {
            return "0";
        }
    ...
    /**
     * 判断字符串是否为null或""，或者trim后长度小于1；true为null或者trim后长度小于1，引用org.apache.commons.
     * lang.StringUtils.isEmpty(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 去掉字符串两端的控制符，如果变为null或""，则返回""，引用org.apache.commons.lang.StringUtils.
     * trimToEmpty(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 比较两个字符串是否相等，相等返回true，引用org.apache.commons.lang.StringUtils.equals(String
     * str1, String str2)方法。<br>
     * 
     * @param str1
     *            字符串1 - 可能为null
     * @param str2
    ...
    /**
     * 比较两个字符串是否相等（不考虑大小写），引用org.apache.commons.lang.StringUtils.
     * equalsIgnoreCase(String str1,String str2)方法。<br>
    ...
    /**
     * 判断某字符串是否为空或长度为0或由空白符(whitespace)构成，引用org.apache.commons.lang.StringUtils.
     * isBlank(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 判断某字符串是否不为空且长度不为0且不由空白符(whitespace)构成，引用org.apache.commons.lang.
     * StringUtils.isNotBlank(String str)方法。<br>
     * 和isBlank()方法相反。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串是否不""空或者不为null，引用org.apache.commons.lang.StringUtils.isNotEmpty(
     * String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串的内容是否只包含数字，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isNumeric(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串的内容是否只包含数字或空格，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isNumericSpace(String str)方法。<br>
     * 例： <br>
     * StringUtil.isNumeric(null) = false <br>
     * StringUtil.isNumeric("") = true <br>
     * StringUtil.isNumeric("  ") = true <br>
    ...
    /**
     * 检查字符串的内容是否只包含空格，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isWhitespace(String str)方法。 <br>
     * 例： <br>
    ...
    /**
     * 检查字符串中的内容是否只包含字母，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isAlpha(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串中的内容是否只包含字母和空格，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isAlphaSpace(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串中的内容是否只包含数字或字母，字符串为null将返回false，""将返回true，引用org.apache.commons.lang.
     * StringUtils.isAlphanumeric(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 检查字符串中的内容是否只包含数字、字母或空格，字符串为null将返回false，""将返回true，引用org.apache.commons.
     * lang.StringUtils.isAlphanumericSpace(String str)方法。<br>
     * 例： <br>
     * StringUtil.isAlphanumeric(null) = false <br>
     * StringUtil.isAlphanumeric("") = true <br>
     * StringUtil.isAlphanumeric("  ") = true <br>
    ...
    /**
     * 检查字符串是否只含有ASCII的可打印字符，字符串为null将返回false，""将返回true，引用org.apache.commons.
     * lang.StringUtils.isAsciiPrintable(String str)方法。<br>
     * 例： <br>
    ...
    /**
     * 返回str的一个子字符串，该子字符串从指定索引处start的字符开始，直到此字符串末尾，引用org.apache.commons.lang.
     * StringUtils.subString(String str,int start)方法。<br>
    ...
    /**
     * 返回str的一个子字符串，该子字符串从指定的start处开始，直到索引end-1处的字符，引用org.apache.commons.lang.
     * StringUtils.subString(String str,int start,int end)方法。<br>
     * 例： <br>
     * StringUtil.substring(null, *, *) = null <br>
     * StringUtil.substring("", * , *) = ""; <br>
    ...
    /**
     * 返回str的一个从separator开始后的一个子字符串（从最左面出现的separator开始，不包括separator），引用org.
     * apache.commons.lang.StringUtils.substringAfter(String str,String
     * separator)方法。<br>
    ...
    /**
     * 返回str的一个从separator开始后的一个子字符串（从最右面出现的separator开始，不包括separator），引用org.
     * apache.commons.lang.StringUtils.substringAfterLast(String str,String
     * separator)方法。<br>
     * 字符串str为null将返回null，""将返回""。字符串str不为null时，如果separator为null将返回""。<br>
     * 例：<br>
    ...
    /**
     * 返回str的一个从separator结束前的一个子字符串（从最左面出现的separator开始，不包括separator），引用org.
     * apache.commons.lang.StringUtils.substringBefore(String str,String
     * separator)方法。<br>
    ...
    /**
     * 返回str的一个从separator结束前的一个子字符串（从最右面出现的separator开始，不包括separator），引用org.
     * apache.commons.lang.StringUtils.substringBeforeLast(String str,String
     * separator)方法。<br>
    ...
    /**
     * 在字符串str中返回一个在字符串tag之间的一个子字符串，引用org.apache.commons.lang.StringUtils.
     * substringBetween(String str,String tag)方法。<br>
    ...
    /**
     * 获得在str中从open开始到close结束之间的子字符串(返回最左面匹配的子字符串)，引用org.apache.commons.lang.
     * StringUtils.substringBetween(String str,String open,String close)方法。<br>
     * 如果str为null将返回null，如果open或close为null将返回null(没有匹配的)，如果open和close为""将返回""字符串
     * 。<br>
     * 例：<br>
    ...
    /**
     * 返回所有在字符串str中从open开始到close结束的子字符串数组，引用org.apache.commons.lang.StringUtils.
     * substringsBetween(String str,String open,String close)方法。<br>
     * 如果str为null将返回null，如果open或close为null将返回null(没有匹配的)，如果open和close为""将返回null(
     * 没有匹配的)。<br>
     * 例：<br>
    ...
    /**
     * 字符串str为null或""替换，假如str为null或""将返回默认的字符串defaultStr，引用org.apache.commons.
     * lang.StringUtils.defaultIfEmpty(String str,String defaultStr)方法。<br>
     * 例：<br>
    ...
    /**
     * 字符串str为null或""处理，假如str为null或""将返回""，引用org.apache.commons.lang.StringUtils
     * .defaultString(String str)方法。<br>
    ...
    /**
     * 字符串str为null或""替换,假如str为null将返回默认的字符串defaultStr，为""将返回"",引用org.apache.
     * commons.lang.StringUtils.defaultString(String str,String defaultStr)方法。<br>
     * 例：<br>
    ...
    /**
     * 用空格作为分割符，分割str为数组，分隔符不能作为数组中的元素返回(空格不可以当作数组中的一个元素返回)，引用org.apache.commons
     * .lang.StringUtils.split(String str)方法。<br>
    ...
    /**
     * 参数separatorChar字符作为分隔符，把字符串str分割为数组，分隔符不能作为数组中的元素返回(空格不可以当作数组中的一个元素返回)，
     * 引用org.apache.commons.lang.StringUtils.split方法(String str,char
     * separatorChar)。<br>
     * 如果str为null将返回null。<br>
     * 例：<br>
     * StringUtil.split(null, *) = null <br>
    ...
    /**
     * 参数separatorChars字符串作为分隔符，把字符串str分割为数组，分隔符不能作为数组中的元素返回(空格不可以当作数组中的一个元素返回)，
     * 引用org.apache.commons.lang.StringUtils.split(String str,String
     * separatorChars)方法。<br>
    ...
    /**
     * 根据参数separatorChars字符串作为分隔符按照最大长度max，把字符串str分割为数组，分隔符不能作为数组中的元素返回(
     * 空格不可以当作数组中的一个元素返回)，引用org.apache.commons.lang.StringUtils.split(String
     * str,String separatorChars,int max)方法。<br>
    ...
    /**
     * 完全按照给定的参数separatorChars作为分隔符把字符串str分割为数组，分隔符不能作为数组中的元素返回(
     * 空格不可以当作数组中的一个元素返回
     * )，引用org.apache.commons.lang.StringUtils.splitByWholeSeparator(String
     * str,String separator)方法。<br>
     * 如果str为null将返回null，null当作空格分隔符。<br>
     * 例： <br>
     ...
     * StringUtil.splitByWholeSeparator("ab-!-cd-!-ef", "-!-") = ["ab", "cd",
     * "ef"] <br>
     * 
     * @param str
     *            分割的字符串 - 可能为null
     ...
     * 根据参数separatorChars字符串作为分隔符按照最大长度max，把字符串str分割为数组，分隔符不能作为数组中的元素返回(
     * 空格不可以当作数组中的一个元素返回)，引用org.apache.commons.lang.StringUtils.split(String
     * str,String separator,int max)方法。<br>
     * 如果按分隔符分割出来的数组大于max，就把分隔符最左面的作为数组中的一个元素，右面作为另一个元素。<br>
     * 如果str为null将返回null，null当作空格分隔符。<br>
     * 例：<br>
     * StringUtil.splitByWholeSeparator(null, *, *) = null <br>
     * StringUtil.splitByWholeSeparator("", *, *) = [] <br>
     * StringUtil.splitByWholeSeparator("ab de fg", null, 0) = ["ab", "de",
     * "fg"] <br>
     * StringUtil.splitByWholeSeparator("ab   de fg", null, 0) = ["ab", "de",
     * "fg"] <br>
     * StringUtil.splitByWholeSeparator("ab:cd:ef", ":", 2) = ["ab", "cd:ef"] <br>
     * StringUtil.splitByWholeSeparator("ab-!-cd-!-ef", "-!-", 5) = ["ab", "cd",
     * "ef"] <br>
     * StringUtil.splitByWholeSeparator("ab-!-cd-!-ef", "-!-", 2) = ["ab",
     * "cd-!-ef"] <br>
     * 
     * @param str
     *            分割的字符串 - 可能为null
    ...
    /**
     * 用空格作为分割符，分割str为数组，分隔符不能作为数组中的元素返回(空格可以当作数组中的一个元素返回)，引用org.apache.commons.
     * lang.StringUtils.splitPreserveAllTokens(String str)方法。<br>
     * 如果str为null将返回null，null当作空格分隔符。<br>
     * 例：<br>
    ...
    /**
     * 参数separatorChar字符作为分隔符，把字符串str分割为数组，分隔符不能作为数组中的元素返回(空格可以当作数组中的一个元素返回)，
     * 引用org.apache.commons.lang.StringUtils.splitPreserveAllTokens(String
     * str,char separatorChar)方法。<br>
     * 如果str为null将返回null。<br>
     * 例：<br>
     * StringUtil.splitPreserveAllTokens(null, *) = null <br>
     * StringUtil.splitPreserveAllTokens("", *) = [] <br>
     ...
     * ""] <br>
     * StringUtil.splitPreserveAllTokens(" a b c", ' ') = ["", a", "b", "c"] <br>
     * StringUtil.splitPreserveAllTokens("  a b c", ' ') = ["", "",
     * a", "b", "c"] <br>
     * StringUtil.splitPreserveAllTokens(" a b c ", ' ') = ["",
     * a", "b", "c", ""] <br>
     * 
    ...
    /**
     * 参数separatorChars字符串作为分隔符，把字符串str分割为数组，分隔符不能作为数组中的元素返回(空格可以当作数组中的一个元素返回)，
     * 引用org.apache.commons.lang.StringUtils.splitPreserveAllTokens(String
     * str,String separatorChars)方法。<br>
     * 如果str为null将返回null，null当作空格分隔符。<br>
     * 例：<br>
     * StringUtil.splitPreserveAllTokens(null, *) = null <br>
     * StringUtil.splitPreserveAllTokens("", *) = [] <br>
     ...
     * StringUtil.splitPreserveAllTokens("ab:cd:ef::", ":") = ["ab", "cd", "ef",
     * "", ""] <br>
     * StringUtil.splitPreserveAllTokens("ab::cd:ef", ":") = ["ab", "",
     * cd", "ef"] <br>
     ...
     * StringUtil.splitPreserveAllTokens(null, *, *) = null] <br>
     * StringUtil.splitPreserveAllTokens("", *, *) = []] <br>
     * StringUtil.splitPreserveAllTokens("ab   de fg", null, 0) = ["ab", "cd",
     * "ef"]] <br>
     * StringUtil.splitPreserveAllTokens("ab:cd:ef", ":", 2) = ["ab", "cd:ef"]] <br>
     * StringUtil.splitPreserveAllTokens("ab   de fg", null, 2) = ["ab",
     * "  de fg"]] <br>
     * StringUtil.splitPreserveAllTokens("ab   de fg", null, 3) = ["ab", "",
     * " de fg"]] <br>
     * StringUtil.splitPreserveAllTokens("ab   de fg", null, 4) = ["ab", "", "",
     * "de fg"]]<br>
     * 
     * @param str
     *            分割的字符串 - 可能为null
    ...
    /**
     * 获得从字符串str从最左面开始len长度字符串，引用org.apache.commons.lang.StringUtils.left(String
     * str,int len)方法。<br>
     * 例：<br>
    ...
    /**
     * 用空格填补在字符串的最左面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.StringUtils.
     * leftPad(String str,int size)方法。<br>
     * 例： <br>
     ...
     *            可能是填补后的字符串的长度
     * @return String
     *         左面被填补后的字符串或原始的字符串，如果参数size-str的长度=>1就不用填补，如果字符串为null就返回null。
     */
    ...
    /**
     * 用字符padChar填补在字符串的最左面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.
     * StringUtils.leftPad(String str,int size,char padChar)方法。<br>
     * 例： <br>
     * StringUtil.leftPad(null, *, *) = null <br>
    ...
    /**
     * 用指定的字符串padStr填补在字符串的最左面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.
     * StringUtils.leftPad(String str,int size,String padStr)方法。<br>
    ...
    /**
     * 获得从字符串str最右面开始len长度字符串，引用org.apache.commons.lang.StringUtils.right(String
     * str,int len)方法。<br>
     * 例：<br>
    ...
    /**
     * 用空格填补在字符串的最右面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.StringUtils.
     * rightPad(String str,int size)方法。<br>
     * 例： <br>
     ...
     *            可能是填补后的字符串的长度
     * @return String
     *         右面被填补后的字符串或原始的字符串，如果参数size-str的长度=>1就不用填补，如果字符串为null就返回null。
     */
    ...
    /**
     * 用字符padChar填补在字符串的最右面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.
     * StringUtils.rightPad(String str,int size,char padChar)方法。<br>
     * 例： <br>
     * StringUtil.rightPad(null, *, *) = null <br>
    ...
    /**
     * 用指定的字符串padStr填补在字符串的最右面，填补的长度等于参数size-str的长度，引用org.apache.commons.lang.
     * StringUtils.rightPad(String str,int size,String padStr)方法。<br>
     * 如果填补时剩下的长度 < 要填补的字符串padStr的长度，就从padStr最左面的字符开始直到填补后的长度 = 参数size为止 。<br>
     * 例： <br>
     * StringUtil.rightPad(null, *, *) = null <br>
     * StringUtil.rightPad("", 3, "z") = "zzz" <br>
    ...
    /**
     * 把对象数组中单独的字符串元素连接成一个字符串，引用org.apache.commons.lang.StringUtils.join(Object[
     * ] array)方法。<br>
    ...
    /**
     * 在原对象数组的基础上用指定的字符(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.apache.
     * commons.lang.StringUtils.join(Object[] array,char separator)方法。<br>
    ...
    /**
     * 在原对象数组的基础上用指定的字符串(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.apache.
     * commons.lang.StringUtils.join(Object[] array,String separator)方法。<br>
    ...
    /**
     * 把数组中的元素连接成一个字符串返回,把分隔符separator也加上,连接的开始位置为startIndex,结束位置为endIndex，引用org
     * .apache.commons.lang.StringUtils.join(Object[] array,String separator,int
     * startIndex,int endIndex)方法。<br>
     * 
     * @param array
     *            被连接的对象数组 - 可能为null
     * @param separator
    ...
    /**
     * 把数组中的元素连接成一个字符串返回,把分隔符separator也加上,连接的开始位置为startIndex,结束位置为endIndex，引用org
     * .apache.commons.lang.StringUtils.join(Object[] array,char separator,int
     * startIndex,int endIndex)方法。<br>
     * 
     * @param array
     *            被连接的对象数组 - 可能为null
    ...
    /**
     * 把Collection中的元素用指定的字符(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.
     * apache.commons.lang.StringUtils.join(Collection<Object> collection,char
     * separator)方法。<br>
    ...
    /**
     * 把Collection中的元素用指定的字符串(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.
     * apache.commons.lang.StringUtils.join(Collection<Object> collection,String
     * separator)方法。<br>
    ...
    /**
     * 把Iterator中的元素用指定的字符(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.apache.
     * commons.lang.StringUtils.join(Iterator<Object> iterator,char
     * separator)方法。<br>
    ...
    /**
     * 把Iterator中的元素用指定的字符串(separator)当作分隔符把数组中的元素连接成一个字符串(包括分隔符在内)，引用org.apache
     * .commons.lang.StringUtils.join(Iterator<Object> iterator,String
     * separator)方法。<br>
     ...
     * @throws UnsupportedEncodingException
     */
    public static String drc4( String value, String key ) throws UnsupportedEncodingException {
        RC4Engine engine = new RC4Engine();
        CipherParameters parameters = new KeyParameter( key.getBytes( "gbk" ) );
        engine.init( false, parameters );
        int len = value.getBytes( "gbk" ).length;
        ...
        String base64Encrypt = new String( Base64.decodeBase64( bytes ), "gbk" );
    ...
    private static boolean isone( List<Object> a, int b ) {
        ...
        for ( int i = 0; i < a.size(); i++ ) {
            if ( a.get( i ).toString().equals( String.valueOf( b ) ) ) {
                one = false;
                i = a.size();
            }
        }
    ...
    /**
     * 修改SqlMaker由$in传入字串後所产出的sql错误(去掉")
     * 
     * @param sql
     * @return
     */
    public static String changeSqlByIn( String sql ) {
        Pattern pattern = Pattern.compile( "in \"(.+)\"" );
        Matcher matcher = pattern.matcher( sql );

        while ( matcher.find() ) {
            String newStr = matcher.group().replaceAll( "\"", "" );
            sql = matcher.replaceAll( newStr );
        }
        return sql;
    }
    
    public static int formatObjInt(Object obj) {
     ...
     * @return randomNmEn
     */
    public static String getRandomNmEn(int length) {
        
        String[] str = "1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");
