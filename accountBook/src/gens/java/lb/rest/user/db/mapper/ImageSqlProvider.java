...
import lb.rest.user.db.entity.ImageExample.Criterion;
...
public class ImageSqlProvider {
    ...
    public String insertSelective(Image record) {
        ...
        if (record.getImagename() != null) {
            VALUES("imagename", "#{imagename,jdbcType=VARCHAR}");
        }
        
        if (record.getImagepath() != null) {
            VALUES("imagepath", "#{imagepath,jdbcType=VARCHAR}");
        }
        ...
        if (record.getImagetype() != null) {
            VALUES("imagetype", "#{imagetype,jdbcType=VARCHAR}");
        }
        
        if (record.getForeignkey() != null) {
            VALUES("foreignkey", "#{foreignkey,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getImagename() != null) {
            SET("imagename = #{record.imagename,jdbcType=VARCHAR}");
        }
        
        if (record.getImagepath() != null) {
            SET("imagepath = #{record.imagepath,jdbcType=VARCHAR}");
        }
        ...
        if (record.getImagetype() != null) {
            SET("imagetype = #{record.imagetype,jdbcType=VARCHAR}");
        }
        
        if (record.getForeignkey() != null) {
            SET("foreignkey = #{record.foreignkey,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Image record) {
        ...
        if (record.getForeignkey() != null) {
            SET("foreignkey = #{foreignkey,jdbcType=INTEGER}");
        }
