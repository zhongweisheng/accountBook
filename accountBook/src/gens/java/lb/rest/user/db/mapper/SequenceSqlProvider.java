...
import lb.rest.user.db.entity.SequenceExample.Criteria;
import lb.rest.user.db.entity.SequenceExample.Criterion;
...
public class SequenceSqlProvider {
     ...
     */
    public String countByExample(SequenceExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("sequence");
     ...
     * @mbggenerated Thu Feb 16 17:53:28 CST 2017
     */
    public String deleteByExample(SequenceExample example) {
        BEGIN();
        DELETE_FROM("sequence");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Feb 16 17:53:28 CST 2017
     */
    public String selectByExample(SequenceExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Sequence record = (Sequence) parameter.get("record");
        SequenceExample example = (SequenceExample) parameter.get("example");
     ...
     * @mbggenerated Thu Feb 16 17:53:28 CST 2017
     */
    protected void applyWhere(SequenceExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
