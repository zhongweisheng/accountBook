...
public interface BsInventoryOperateMapper {
     ...
     */
    @Insert({
        "insert into bs_inventory_operate (id, owner_id, ",
        "target_type, target_id, ",
        "operate_time, operate_user_id, ",
        "operate_user_name, operate_type, ",
        "operate_name, content, ",
        "remark, depot_id, ",
        "from_type, int_column1, ",
        "int_column2, str_column1, ",
        "str_column2)",
        "values (#{id,jdbcType=BIGINT}, #{ownerId,jdbcType=INTEGER}, ",
        "#{targetType,jdbcType=INTEGER}, #{targetId,jdbcType=INTEGER}, ",
        ...
        "#{remark,jdbcType=VARCHAR}, #{depotId,jdbcType=INTEGER}, ",
        "#{fromType,jdbcType=INTEGER}, #{intColumn1,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, owner_id, target_type, target_id, operate_time, operate_user_id, operate_user_name, ",
        "operate_type, operate_name, content, remark, depot_id, from_type, int_column1, ",
        "int_column2, str_column1, str_column2",
