  ...
  $.fn.extend({
    ...
    page: function (options) {
      ...
      return this.each(function () {
        ...
        if (l > 1&&l < 10) {
          str1 = '<li><a  class="'+ opts.activeClass +'">1</a></li>';
          for (i = 2; i < l + 1; i++) {
            str += '<li><a >' + i + '</a></li>';
          }
        }else if(l > 9){
        ...
        //   obj.html('<div class="first" style="float:left">' + opts.firstPage + '</div><div class="prv" style="float:left">' + opts.prv + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="next" style="float:left">' + opts.next + '</div><div class="last" style="float:left">' + opts.lastPage + '</div>');
          obj.html('<div class="first" style="float:left">' + opts.firstPage + '</div><ul class="pagingUl">' + str1 + str + '</ul><div class="last" style="float:left">' + opts.lastPage + '</div>');
          obj.on('click', '.next', function () {
          var pageshow = parseInt($('.' + opts.activeClass).html());
              // alert("page.js===="+pageshow);
          if(pageshow == l) {
        ...
        function fpageShow(){
          ...
          var str1 = '';
          for(i=0;i<9;i++){
            str1 += '<li><a  class="">' + (pageStart+i) + '</a></li>'
          }
