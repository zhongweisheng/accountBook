...
var driverArray = [];
var driver = Restful.post('bsinventorystaff/list',{userId:ownerId,staffType:2,pageSize:1000});
if(driver){
    if(driver.success){
...
function getData(){
 ...
 /*   params.staffName = name;*/
    ...
    if(res.success){
        ...
        var msg = $('#outStorage-list').html();
        var compiledTemplate = Template7.compile(msg);
        var html = compiledTemplate({"outStorage":data});
        $("#list").html(html);
