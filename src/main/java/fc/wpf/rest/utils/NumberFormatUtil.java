...
public class NumberFormatUtil {
	...
	public static final DecimalFormat dfP2 = new DecimalFormat("###0.##");
	public static final DecimalFormat dfP3 = new DecimalFormat("###0.###");
	...
	/**
	 * 根据给定长度截取数值，如果number为100010，length长度为4，那么返回0010(number值后4位)。
	 * 如果number的长度小于length，那么返回number本身。
	 * 
	 * @param number
	 *            数值
	 * @param length
	...
	public static String formatToPercent(DecimalFormat df4, Double doubleVal) {
		if (doubleVal == null) {
			return "";
		}
		return df4.format(doubleVal);
	...
	public static void main(String[] args) {
		Double doubleVal = 99034.123d;
		System.out.println(formatMoneyPercent(doubleVal));
		System.out.println(formatToPercent(doubleVal));
		DecimalFormat df3 = new DecimalFormat("###0.000");
		System.out.println(formatToPercent(df3, doubleVal));
		df3 = new DecimalFormat("###,###,###,##0.###");
		System.out.println(formatToPercent(df3, doubleVal));

		/**
		 * 99034.12 99,034.12 99034.123 99,034.123
		 */
	}
}
