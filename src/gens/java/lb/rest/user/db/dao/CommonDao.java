...
public class CommonDao {
	...
	public List<MlbUserBO> selectMlbUserHasBuyList(double lat, double lng, double maxDistance, double minDistance,
			int foodType, String location, String createTime) {

		List<MlbUserBO> list = mapper.selectMlbUserHasBuyList(2, foodType, location, createTime);
