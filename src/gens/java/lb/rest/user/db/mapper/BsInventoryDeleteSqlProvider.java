...
import lb.rest.user.db.entity.BsInventoryDeleteExample.Criterion;
import lb.rest.user.db.entity.BsInventoryDeleteExample;

public class BsInventoryDeleteSqlProvider {
     ...
     */
    public String countByExample(BsInventoryDeleteExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String deleteByExample(BsInventoryDeleteExample example) {
        BEGIN();
        DELETE_FROM("bs_inventory_delete");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String insertSelective(BsInventoryDelete record) {
        BEGIN();
        INSERT_INTO("bs_inventory_delete");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String selectByExample(BsInventoryDeleteExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BsInventoryDelete record = (BsInventoryDelete) parameter.get("record");
        BsInventoryDeleteExample example = (BsInventoryDeleteExample) parameter.get("example");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String updateByPrimaryKeySelective(BsInventoryDelete record) {
        BEGIN();
        UPDATE("bs_inventory_delete");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    protected void applyWhere(BsInventoryDeleteExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
