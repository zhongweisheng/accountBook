...
import lb.rest.user.db.entity.BsInventoryStorageExample.Criterion;
import lb.rest.user.db.entity.BsInventoryStorageExample;

public class BsInventoryStorageSqlProvider {
     ...
     */
    public String countByExample(BsInventoryStorageExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Thu May 18 13:15:19 CST 2017
     */
    public String deleteByExample(BsInventoryStorageExample example) {
        BEGIN();
        DELETE_FROM("bs_inventory_storage");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu May 18 13:15:19 CST 2017
     */
    public String insertSelective(BsInventoryStorage record) {
        BEGIN();
        INSERT_INTO("bs_inventory_storage");
     ...
     * @mbggenerated Thu May 18 13:15:19 CST 2017
     */
    public String selectByExample(BsInventoryStorageExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BsInventoryStorage record = (BsInventoryStorage) parameter.get("record");
        BsInventoryStorageExample example = (BsInventoryStorageExample) parameter.get("example");
     ...
     * @mbggenerated Thu May 18 13:15:19 CST 2017
     */
    public String updateByPrimaryKeySelective(BsInventoryStorage record) {
        BEGIN();
        UPDATE("bs_inventory_storage");
     ...
     * @mbggenerated Thu May 18 13:15:19 CST 2017
     */
    protected void applyWhere(BsInventoryStorageExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
