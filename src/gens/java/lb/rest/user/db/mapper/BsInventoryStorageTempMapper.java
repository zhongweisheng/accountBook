...
public interface BsInventoryStorageTempMapper {
    /**
     ...
     */
    @SelectProvider(type=BsInventoryStorageTempSqlProvider.class, method="countByExample")
    int countByExample(BsInventoryStorageTempExample example);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @DeleteProvider(type=BsInventoryStorageTempSqlProvider.class, method="deleteByExample")
    int deleteByExample(BsInventoryStorageTempExample example);
     ...
     */
    @Delete({
        "delete from bs_inventory_storage_temp",
        "where id = #{id,jdbcType=INTEGER}"
    })
    int deleteByPrimaryKey(BsInventoryStorageTempKey key);
     ...
     */
    @Insert({
        "insert into bs_inventory_storage_temp (id, user_id, ",
    ...
    int insert(BsInventoryStorageTemp record);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @InsertProvider(type=BsInventoryStorageTempSqlProvider.class, method="insertSelective")
    int insertSelective(BsInventoryStorageTemp record);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @SelectProvider(type=BsInventoryStorageTempSqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<BsInventoryStorageTemp> selectByExample(BsInventoryStorageTempExample example);
    ...
    @Select({
        ...
        "from bs_inventory_storage_temp",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
    ...
    BsInventoryStorageTemp selectByPrimaryKey(BsInventoryStorageTempKey key);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @UpdateProvider(type=BsInventoryStorageTempSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") BsInventoryStorageTemp record, @Param("example") BsInventoryStorageTempExample example);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @UpdateProvider(type=BsInventoryStorageTempSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") BsInventoryStorageTemp record, @Param("example") BsInventoryStorageTempExample example);
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    @UpdateProvider(type=BsInventoryStorageTempSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(BsInventoryStorageTemp record);
     ...
     */
    @Update({
        "update bs_inventory_storage_temp",
    ...
    int updateByPrimaryKey(BsInventoryStorageTemp record);
}