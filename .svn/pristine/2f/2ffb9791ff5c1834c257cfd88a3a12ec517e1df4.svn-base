...
import lb.rest.user.db.entity.BsInventoryTemporaryExample.Criterion;
import lb.rest.user.db.entity.BsInventoryTemporaryExample;

public class BsInventoryTemporarySqlProvider {
     ...
     */
    public String countByExample(BsInventoryTemporaryExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String deleteByExample(BsInventoryTemporaryExample example) {
        BEGIN();
        DELETE_FROM("bs_inventory_temporary");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String insertSelective(BsInventoryTemporary record) {
        BEGIN();
        INSERT_INTO("bs_inventory_temporary");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String selectByExample(BsInventoryTemporaryExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BsInventoryTemporary record = (BsInventoryTemporary) parameter.get("record");
        BsInventoryTemporaryExample example = (BsInventoryTemporaryExample) parameter.get("example");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    public String updateByPrimaryKeySelective(BsInventoryTemporary record) {
        BEGIN();
        UPDATE("bs_inventory_temporary");
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    protected void applyWhere(BsInventoryTemporaryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
