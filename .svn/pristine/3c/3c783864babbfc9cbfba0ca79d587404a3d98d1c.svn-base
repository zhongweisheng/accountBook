...
public interface BsInventoryTemporaryMapper {
    /**
     ...
     */
    @SelectProvider(type=BsInventoryTemporarySqlProvider.class, method="countByExample")
    int countByExample(BsInventoryTemporaryExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @DeleteProvider(type=BsInventoryTemporarySqlProvider.class, method="deleteByExample")
    int deleteByExample(BsInventoryTemporaryExample example);
     ...
     */
    @Delete({
        "delete from bs_inventory_temporary",
        "where id = #{id,jdbcType=INTEGER}"
    })
    int deleteByPrimaryKey(BsInventoryTemporaryKey key);
     ...
     */
    @Insert({
        "insert into bs_inventory_temporary (id, user_id, ",
    ...
    int insert(BsInventoryTemporary record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @InsertProvider(type=BsInventoryTemporarySqlProvider.class, method="insertSelective")
    int insertSelective(BsInventoryTemporary record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @SelectProvider(type=BsInventoryTemporarySqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<BsInventoryTemporary> selectByExample(BsInventoryTemporaryExample example);
    ...
    @Select({
        ...
        "unpaid_money, if_clear, operate_user_id, operate_user_name, depot_id",
        "from bs_inventory_temporary",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
        @Result(column="id", property="id", jdbcType=JdbcType.INTEGER, id=true),
    ...
    BsInventoryTemporary selectByPrimaryKey(BsInventoryTemporaryKey key);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryTemporarySqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") BsInventoryTemporary record, @Param("example") BsInventoryTemporaryExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryTemporarySqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") BsInventoryTemporary record, @Param("example") BsInventoryTemporaryExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryTemporarySqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(BsInventoryTemporary record);
    ...
    int updateByPrimaryKey(BsInventoryTemporary record);
}