...
public interface BsInventoryRecordMapper {
    /**
     ...
     */
    @SelectProvider(type=BsInventoryRecordSqlProvider.class, method="countByExample")
    int countByExample(BsInventoryRecordExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @DeleteProvider(type=BsInventoryRecordSqlProvider.class, method="deleteByExample")
    int deleteByExample(BsInventoryRecordExample example);
     ...
     */
    @Delete({
        "delete from bs_inventory_record",
        "where id = #{id,jdbcType=INTEGER}"
    })
    int deleteByPrimaryKey(BsInventoryRecordKey key);
     ...
     */
    @Insert({
        "insert into bs_inventory_record (id, user_id, ",
    ...
    int insert(BsInventoryRecord record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @InsertProvider(type=BsInventoryRecordSqlProvider.class, method="insertSelective")
    int insertSelective(BsInventoryRecord record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @SelectProvider(type=BsInventoryRecordSqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<BsInventoryRecord> selectByExample(BsInventoryRecordExample example);
    ...
    BsInventoryRecord selectByPrimaryKey(BsInventoryRecordKey key);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryRecordSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") BsInventoryRecord record, @Param("example") BsInventoryRecordExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryRecordSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") BsInventoryRecord record, @Param("example") BsInventoryRecordExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryRecordSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(BsInventoryRecord record);
    ...
    int updateByPrimaryKey(BsInventoryRecord record);
}