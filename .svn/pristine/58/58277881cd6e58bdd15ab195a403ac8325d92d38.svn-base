...
public interface BsInventoryDeleteMapper {
    /**
     ...
     */
    @SelectProvider(type=BsInventoryDeleteSqlProvider.class, method="countByExample")
    int countByExample(BsInventoryDeleteExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @DeleteProvider(type=BsInventoryDeleteSqlProvider.class, method="deleteByExample")
    int deleteByExample(BsInventoryDeleteExample example);
     ...
     */
    @Delete({
        "delete from bs_inventory_delete",
        "where id = #{id,jdbcType=INTEGER}"
    })
    int deleteByPrimaryKey(BsInventoryDeleteKey key);
     ...
     */
    @Insert({
        "insert into bs_inventory_delete (id, user_id, ",
    ...
    int insert(BsInventoryDelete record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @InsertProvider(type=BsInventoryDeleteSqlProvider.class, method="insertSelective")
    int insertSelective(BsInventoryDelete record);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @SelectProvider(type=BsInventoryDeleteSqlProvider.class, method="selectByExample")
    @Results({
    ...
    List<BsInventoryDelete> selectByExample(BsInventoryDeleteExample example);
    ...
    BsInventoryDelete selectByPrimaryKey(BsInventoryDeleteKey key);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryDeleteSqlProvider.class, method="updateByExampleSelective")
    int updateByExampleSelective(@Param("record") BsInventoryDelete record, @Param("example") BsInventoryDeleteExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryDeleteSqlProvider.class, method="updateByExample")
    int updateByExample(@Param("record") BsInventoryDelete record, @Param("example") BsInventoryDeleteExample example);
     ...
     * @mbggenerated Mon May 15 11:47:33 CST 2017
     */
    @UpdateProvider(type=BsInventoryDeleteSqlProvider.class, method="updateByPrimaryKeySelective")
    int updateByPrimaryKeySelective(BsInventoryDelete record);
    ...
    int updateByPrimaryKey(BsInventoryDelete record);
}