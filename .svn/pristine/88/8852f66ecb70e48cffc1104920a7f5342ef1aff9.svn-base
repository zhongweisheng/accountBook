...
import lb.rest.user.db.entity.BsInventoryStorageTempExample.Criterion;
import lb.rest.user.db.entity.BsInventoryStorageTempExample;

public class BsInventoryStorageTempSqlProvider {
     ...
     */
    public String countByExample(BsInventoryStorageTempExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    public String deleteByExample(BsInventoryStorageTempExample example) {
        BEGIN();
        DELETE_FROM("bs_inventory_storage_temp");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    public String insertSelective(BsInventoryStorageTemp record) {
        BEGIN();
        INSERT_INTO("bs_inventory_storage_temp");
        ...
        if (record.getHasSettled() != null) {
            VALUES("has_settled", "#{hasSettled,jdbcType=DOUBLE}");
        }
        
        if (record.getNotSettled() != null) {
            VALUES("not_settled", "#{notSettled,jdbcType=DOUBLE}");
        }
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    public String selectByExample(BsInventoryStorageTempExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        BsInventoryStorageTemp record = (BsInventoryStorageTemp) parameter.get("record");
        BsInventoryStorageTempExample example = (BsInventoryStorageTempExample) parameter.get("example");
        ...
        if (record.getHasSettled() != null) {
            SET("has_settled = #{record.hasSettled,jdbcType=DOUBLE}");
        }
        
        if (record.getNotSettled() != null) {
            SET("not_settled = #{record.notSettled,jdbcType=DOUBLE}");
        }
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    public String updateByPrimaryKeySelective(BsInventoryStorageTemp record) {
        BEGIN();
        UPDATE("bs_inventory_storage_temp");
        ...
        if (record.getHasSettled() != null) {
            SET("has_settled = #{hasSettled,jdbcType=DOUBLE}");
        }
        
        if (record.getNotSettled() != null) {
            SET("not_settled = #{notSettled,jdbcType=DOUBLE}");
        }
     ...
     * @mbggenerated Thu May 18 17:26:05 CST 2017
     */
    protected void applyWhere(BsInventoryStorageTempExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
